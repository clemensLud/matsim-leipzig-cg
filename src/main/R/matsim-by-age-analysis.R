...
srv.h = read.csv2(SRV.H)

inc.breaks = c(-Inf, 0,1,2,3,4,5)
...
ggplot(compare.3.diff, aes(income_bin, diff, fill = neg)) +
  ...
  labs(y = "MATSim - SrV", x = "Income Group", title = "Difference of MATSim income distribution compared to SrV 2018") +
